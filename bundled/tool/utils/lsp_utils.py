...
def is_same_path(file_path1: os.PathLike, file_path2: os.PathLike) -> bool:
    """Returns true if two paths are the same

    args:
        - `file_path1 (str)`: path to file
        - `file_path2 (str)`: path to file

    returns:
        - `bool`: True if the paths are the same
    """
